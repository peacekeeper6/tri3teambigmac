...
def model_tester():
    ...
    u2 = Users(name='Events Calendar', url='/eventscalendar', description='Calendar for Upcoming Events', usertag="eventscalendar")
    u3 = Users(name='Club Information', url='/clubinfo', description='Information about the club', usertag="information")
    u4 = Users(name='Ocean Information', url='/oceaninfo', description='Information about the problem & how you can help', usertag="information")
    u5 = Users(name='Member Communication', url='/membercommunication', description='Communicate with the members', usertag="members")
